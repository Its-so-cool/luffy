    ...
    export default {
        ...
        methods: {
            ...
            code_login(){
                if(this.mobile&&this.sms){
                    this.$axios.post(this.$settings.base_url+'/user/code_login/',
                         {phone:this.mobile,code:this.sms}).then(
                             response=>{
                                 this.$cookies.set('token',response.data.token,'7d')
                                 this.$cookies.set('username',response.data.username,'7d')
                                 this.$emit('close')
            ...
            check_mobile() {
                ...
                this.$axios.get(this.$settings.base_url+'/user/check_telephone/',{params:{phone:this.mobile}})
                    .then(request=>{
            ...
            send_sms() {
                ...
                this.$axios.post(this.$settings.base_url+'/user/send_phone/',
                    {phone:this.mobile})
                .then(request=>{
                    if (request.data.code){
                        this.$message({
